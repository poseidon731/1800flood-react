...
export function setUserData(user) {
	return dispatch => {
         ...
         */
		if (user.data.isadmin.data[0] === 1) {
			history.push('/apps/admin/dashboard');
		} else {
			history.push('/apps/client/jobs')
		}

		const data = {
			role: user.data.isadmin.data[0] === 1 ? ['admin'] : ['user'],
			...user.data
		};
		/*
        Set User Settings
         */
		//dispatch(FuseActions.setDefaultSettings(user));
